describe("My whatCanIDrink function", function(){
  ...
  describe("Checks age", function(){
    ...
    it("should return drink toddy when called as whatCanIDrink(18)", function() {
      var result = whatCanIDrink(18)
      expect(result).toBe("Drink Beer");
    });

    it("should return drink toddy when called as whatCanIDrink(20)", function() {
      var result = whatCanIDrink(20)
      expect(result).toBe("Drink Beer");
    });

    it("should return drink toddy when called as whatCanIDrink(30)", function() {
